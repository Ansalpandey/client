export default function NewsLetter() {
  return (
      <section className="py-14 max-w-screen-xl mx-auto">
          <div className="relative overflow-hidden mx-4 px-4 py-14 rounded-2xl border border-input bg-gradient-to-br from-blue-500 via-orange-500 via-purple-500 to-pink-500 md:px-8 md:mx-8">
              <div className="relative z-10 max-w-xl mx-auto sm:text-center">
                  ...
                  <div className="mt-6">
                      <form
                          ...
                          className="flex items-center justify-center bg-white rounded-lg p-1 sm:max-w-md sm:mx-auto focus-within:outline-none focus-within:ring-2 focus-within:ring-gray-500">
                          <input
                              type="email"
                              placeholder="Enter your email"
                              className="text-gray-500 w-full p-2 outline-none border-none focus:outline-none focus:ring-0"
                          />
                          <button
