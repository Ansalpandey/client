...
export default function Login() {
  ...
  return (
    <main className="w-full h-screen flex flex-col items-center justify-center relative">
      <div className="absolute top-20 z-[0]  bg-purple-950/10 bg-[radial-gradient(ellipse_20%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]"></div>
      <div className="w-full text-gray-600 sm:max-w-md md:max-w-xl lg:max-w-xl px-5 py-10  rounded-2xl  transform-gpu dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#8686f01f_inset]">
          ...
          <form onSubmit={(e) => e.preventDefault()} className="space-y-5">
            <div>
              ...
              <input
                type="email"
                required
                className="w-full mt-2 px-3 py-3 text-white bg-transparent outline-none border focus:border-purple-600 shadow-sm rounded-lg"
              />
            </div>
            <div>
              <label className="font-medium text-gray-100/50 font-geist">
